...
<div class="container">
    ...
    <form action="realising/addPost.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>
                <input type="radio" name="radioValue" value="0"> Черновик
            </label>
            <label>
                <input type="radio" name="radioValue" value="1"> Опубликовать
            </label>
        </div>
